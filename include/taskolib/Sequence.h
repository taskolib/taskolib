...
public:
    ...
    */
    ...
    /// Return the disable flag. When set to true it will prohibt any execution.
    bool is_disable() const noexcept { return is_disable_; }
...
private:
    ...
    bool is_disable_{ false };     ///< Disable sequence. Used for execution control.
